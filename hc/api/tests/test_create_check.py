...
class CreateCheckTestCase(BaseTestCase):
    ...
    def test_for_timeout_being_too_small(self):
        self.post({"api_key": "abc", "timeout": 1},
                  expected_error="timeout is too small")

    def test_for_timeout_being_too_large(self):
        self.post({"api_key": "abc", "timeout": 3687900},
                  expected_error="timeout is too large")

    def test_assignment_channel(self):
